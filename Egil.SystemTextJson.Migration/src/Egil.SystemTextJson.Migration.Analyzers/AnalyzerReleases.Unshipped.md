...
STJM0006 | Egil.SystemTextJson.Migration | Warning | JsonSerializerContext is missing migration source metadata.
STJM0009 | Egil.SystemTextJson.Migration | Warning | Migration sources have an ambiguous non-object JSON shape.
