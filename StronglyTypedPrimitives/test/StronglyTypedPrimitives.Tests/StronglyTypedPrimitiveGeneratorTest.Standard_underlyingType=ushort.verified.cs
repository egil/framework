...
public readonly partial record struct Foo : global::StronglyTypedPrimitives.IStronglyTypedPrimitive, global::System.IParsable<Foo>
{
    ...
    private readonly ushort @value = ThrowIfValueIsInvalid(Value);       
    ...
    private static ushort ThrowIfValueIsInvalid(ushort value)
    {
    ...
    public static bool IsValueValid(ushort value, bool throwIfInvalid) => true;

    public override string ToString() => Value.ToString();

    public static Foo Parse(string? s, global::System.IFormatProvider? provider)
    {
        var rawValue = ushort.Parse(s!, provider);
    ...
    {
        if (ushort.TryParse(s, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
