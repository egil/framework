...
public readonly partial record struct Foo : global::StronglyTypedPrimitives.IStronglyTypedPrimitive, global::System.IParsable<Foo>
{
    ...
    private readonly sbyte @value = ThrowIfValueIsInvalid(Value);       
    ...
    private static sbyte ThrowIfValueIsInvalid(sbyte value)
    {
    ...
    public static bool IsValueValid(sbyte value, bool throwIfInvalid) => true;

    public override string ToString() => Value.ToString();

    public static Foo Parse(string? s, global::System.IFormatProvider? provider)
    {
        var rawValue = sbyte.Parse(s!, provider);
    ...
    {
        if (sbyte.TryParse(s, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
