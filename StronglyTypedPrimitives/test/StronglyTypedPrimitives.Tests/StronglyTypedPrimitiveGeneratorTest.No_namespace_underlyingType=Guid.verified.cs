...
public readonly partial record struct Foo : global::StronglyTypedPrimitives.IStronglyTypedPrimitive, global::System.IParsable<Foo>
{
    ...
    private readonly Guid @value = ThrowIfValueIsInvalid(Value);       
    ...
    private static Guid ThrowIfValueIsInvalid(Guid value)
    {
    ...
    public static bool IsValueValid(Guid value, bool throwIfInvalid) => true;

    public override string ToString() => Value.ToString();

    public static Foo Parse(string? s, global::System.IFormatProvider? provider)
    {
        var rawValue = Guid.Parse(s!, provider);
    ...
    {
        if (Guid.TryParse(s, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
