...
public readonly partial record struct Foo : global::StronglyTypedPrimitives.IStronglyTypedPrimitive, global::System.IParsable<Foo>
{
    ...
    private readonly ulong @value = ThrowIfValueIsInvalid(Value);       
    ...
    private static ulong ThrowIfValueIsInvalid(ulong value)
    {
    ...
    public static bool IsValueValid(ulong value, bool throwIfInvalid) => true;

    public override string ToString() => Value.ToString();

    public static Foo Parse(string? s, global::System.IFormatProvider? provider)
    {
        var rawValue = ulong.Parse(s!, provider);
    ...
    {
        if (ulong.TryParse(s, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
