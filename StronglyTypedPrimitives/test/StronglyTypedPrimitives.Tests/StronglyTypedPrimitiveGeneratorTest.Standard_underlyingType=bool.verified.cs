...
public readonly partial record struct Foo : global::StronglyTypedPrimitives.IStronglyTypedPrimitive, global::System.IParsable<Foo>
{
    ...
    private readonly bool @value = ThrowIfValueIsInvalid(Value);       
    ...
    private static bool ThrowIfValueIsInvalid(bool value)
    {
    ...
    public static bool IsValueValid(bool value, bool throwIfInvalid) => true;

    public static Foo Parse(string? s, global::System.IFormatProvider? provider)
    {
        var rawValue = bool.Parse(s!, provider);
    ...
    {
        if (bool.TryParse(s, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
