...
public interface IEventPartitonBuilder<TEventGrain, TEventBase, TProjection>
    where TProjection : class, IEventProjection<TProjection>
{
    ...
    /// <returns></returns>
    IEventPartitionConfigurator<TEventGrain, TEvent, TProjection> AddPartition<TEvent>() where TEvent : notnull, TEventBase;
}