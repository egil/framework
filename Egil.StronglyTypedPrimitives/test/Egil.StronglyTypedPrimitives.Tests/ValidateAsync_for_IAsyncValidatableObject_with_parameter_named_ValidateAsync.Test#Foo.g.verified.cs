...
public readonly partial record struct Foo : Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<string>, Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<SomeNamespace.Foo, string>, System.IParsable<SomeNamespace.Foo>, System.ISpanParsable<SomeNamespace.Foo>, System.IComparable<SomeNamespace.Foo>, System.IComparable
{
    ...
    string Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<SomeNamespace.Foo, string>.Value => ValidateAsync;

    public override string ToString() => ValidateAsync ?? string.Empty;
    ...
    public int CompareTo(SomeNamespace.Foo other)
        => (ValidateAsync ?? string.Empty).CompareTo(other.ValidateAsync);
    ...
    public int CompareTo(object? obj)
    {
        ...
        if (obj is Foo other)
        {
            return (ValidateAsync ?? string.Empty).CompareTo(other.ValidateAsync);
        }

        return ((System.IComparable)(ValidateAsync ?? string.Empty)).CompareTo(obj);
    }
    ...
    async System.Collections.Generic.IAsyncEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> System.ComponentModel.DataAnnotations.IAsyncValidatableObject.ValidateAsync(System.ComponentModel.DataAnnotations.ValidationContext validationContext, [System.Runtime.CompilerServices.EnumeratorCancellation] System.Threading.CancellationToken cancellationToken)
    {
        ...
        var asyncResult0 = await ValueValidators.asyncValueValidator0.GetValidationResultAsync(this.ValidateAsync, validationContext, cancellationToken).ConfigureAwait(false);
