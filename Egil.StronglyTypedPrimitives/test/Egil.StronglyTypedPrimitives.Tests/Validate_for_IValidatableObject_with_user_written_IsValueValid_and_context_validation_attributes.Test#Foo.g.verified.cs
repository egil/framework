...
public readonly partial record struct Foo : global::Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<int>, global::Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<global::SomeNamespace.Foo, int>, global::System.IParsable<global::SomeNamespace.Foo>, global::System.ISpanParsable<global::SomeNamespace.Foo>, global::System.IUtf8SpanParsable<global::SomeNamespace.Foo>, global::System.IComparable<global::SomeNamespace.Foo>, global::System.IComparable, global::System.IFormattable, global::System.ISpanFormattable, global::System.IUtf8SpanFormattable
{
    ...
    {
        global::System.ComponentModel.DataAnnotations.ValidationResult? result = null;
        try
        {
            if (!IsValueValid(this.Value, throwIfInvalid: true)) result = new global::System.ComponentModel.DataAnnotations.ValidationResult("Value is not valid.");
        }
        catch (global::System.Exception ex) when (ex is global::System.ArgumentException or global::System.ComponentModel.DataAnnotations.ValidationException)
        {
            result = new global::System.ComponentModel.DataAnnotations.ValidationResult(ex.Message);
        }

        var contextResult0 = ValueValidators.contextValueValidator0.GetValidationResult(this.Value, validationContext);
        if (contextResult0 == global::System.ComponentModel.DataAnnotations.ValidationResult.Success) contextResult0 = null;

        if (result is null && contextResult0 is null) return global::System.Array.Empty<global::System.ComponentModel.DataAnnotations.ValidationResult>();

        var results = new global::System.ComponentModel.DataAnnotations.ValidationResult[(result is null ? 0 : 1) + (contextResult0 is null ? 0 : 1)];
        var index = 0;
        if (result is not null) results[index++] = result;
