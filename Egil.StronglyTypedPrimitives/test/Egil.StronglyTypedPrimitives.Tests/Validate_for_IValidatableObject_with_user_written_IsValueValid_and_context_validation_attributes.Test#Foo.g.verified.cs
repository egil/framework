...
public readonly partial record struct Foo : Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<int>, Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<SomeNamespace.Foo, int>, System.IParsable<SomeNamespace.Foo>, System.ISpanParsable<SomeNamespace.Foo>, System.IUtf8SpanParsable<SomeNamespace.Foo>, System.IComparable<SomeNamespace.Foo>, System.IComparable, System.IFormattable, System.ISpanFormattable, System.IUtf8SpanFormattable
{
    ...
    public System.Collections.Generic.IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> Validate(System.ComponentModel.DataAnnotations.ValidationContext validationContext)
    {
        ...
        try
        {
            if (!IsValueValid(this.Value, throwIfInvalid: true)) result = new System.ComponentModel.DataAnnotations.ValidationResult("Value is not valid.");
        }
        ...
        {
            result = new System.ComponentModel.DataAnnotations.ValidationResult(ex.Message);
        }

        var contextResult0 = ValueValidators.contextValueValidator0.GetValidationResult(this.Value, validationContext);
        if (contextResult0 == System.ComponentModel.DataAnnotations.ValidationResult.Success) contextResult0 = null;

        if (result is null && contextResult0 is null) return System.Array.Empty<System.ComponentModel.DataAnnotations.ValidationResult>();

        var results = new System.ComponentModel.DataAnnotations.ValidationResult[(result is null ? 0 : 1) + (contextResult0 is null ? 0 : 1)];
        var index = 0;
