...
public readonly partial record struct Foo : Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<int>, Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<SomeNamespace.Foo, int>, System.IParsable<SomeNamespace.Foo>, System.ISpanParsable<SomeNamespace.Foo>, System.IUtf8SpanParsable<SomeNamespace.Foo>, System.IComparable<SomeNamespace.Foo>, System.IComparable, System.IFormattable, System.ISpanFormattable, System.IUtf8SpanFormattable
{
    ...
    public static bool IsValueValid(int value, bool throwIfInvalid)
    {
        ...
        if (!valueValidator0.IsValid(value))
        {
            ...
            error0 = valueValidator0.FormatErrorMessage("asyncResult0");
        }
    ...
    {
        var result0 = valueValidator0.GetValidationResult(this.asyncResult0, validationContext);
    ...
    private static readonly SomeNamespace.RemoteCheckAttribute asyncValueValidator0 = new SomeNamespace.RemoteCheckAttribute();
    ...
    public async System.Collections.Generic.IAsyncEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> ValidateAsync(System.ComponentModel.DataAnnotations.ValidationContext validationContext, [System.Runtime.CompilerServices.EnumeratorCancellation] System.Threading.CancellationToken cancellationToken)
    {
        ...
        var asyncResult0_ = await asyncValueValidator0.GetValidationResultAsync(this.asyncResult0, validationContext, cancellationToken).ConfigureAwait(false);
