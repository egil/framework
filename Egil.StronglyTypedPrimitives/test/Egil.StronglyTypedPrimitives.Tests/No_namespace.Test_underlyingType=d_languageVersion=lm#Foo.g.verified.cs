...
public readonly partial record struct Foo : global::Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<double>, global::Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<global::Foo, double>, global::System.IParsable<global::Foo>, global::System.ISpanParsable<global::Foo>, global::System.IUtf8SpanParsable<global::Foo>, global::System.IComparable<global::Foo>, global::System.IComparable, global::System.IFormattable, global::System.ISpanFormattable, global::System.IUtf8SpanFormattable
{
    ...
    {
        var rawValue = double.Parse(s, provider);
    ...
    {
        if (double.TryParse(s, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
    ...
    {
        var rawValue = double.Parse(utf8Text, provider);
        IsValueValid(rawValue, throwIfInvalid: true);
        return new Foo(rawValue);
    }
    ...
    {
        if (double.TryParse(utf8Text, provider, out var rawValue) && IsValueValid(rawValue, throwIfInvalid: false))
        {
            result = new Foo(rawValue);
            return true;
        }
