...
public readonly partial record struct Foo : Egil.StronglyTypedPrimitives.IStronglyTypedPrimitive<decimal>, System.IParsable<Foo>, System.ISpanParsable<Foo>, System.IUtf8SpanParsable<Foo>, System.IComparable<Foo>, System.IComparable, System.IFormattable, System.ISpanFormattable, System.IUtf8SpanFormattable
{
    ...
    private sealed class FooJsonConverter : System.Text.Json.Serialization.JsonConverter<Foo>
    {
        public override Foo Read(ref System.Text.Json.Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options)
            => new Foo(System.Text.Json.JsonSerializer.Deserialize<decimal>(ref reader, options)!);
