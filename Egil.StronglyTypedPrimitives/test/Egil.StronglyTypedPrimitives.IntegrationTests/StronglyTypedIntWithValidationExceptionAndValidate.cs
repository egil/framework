...
{
    [StronglyTyped]
    public readonly partial record struct StronglyTypedIntWithValidationExceptionAndValidate(int Value) : IValidatableObject
    {
        public static bool IsValueValid(int value, bool throwIfInvalid)
        {
            ...
            if (throwIfInvalid)
                throw new ValidationException("Value must be larger than 5");
