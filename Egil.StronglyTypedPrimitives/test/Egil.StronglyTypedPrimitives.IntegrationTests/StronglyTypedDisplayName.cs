...
{
    [StronglyTyped]
    public readonly partial record struct StronglyTypedDisplayName([StringLength(6, MinimumLength = 2), NotBlankAsync, KnownWord] string Value) : IAsyncValidatableObject;
}
#endif