...
{
    [StronglyTyped]
    public readonly partial record struct StronglyTypedIntWithEmptyField(int Value)
    {
        public static readonly StronglyTypedIntWithEmptyField Empty = new(int.MaxValue);
