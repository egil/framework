...
{
    [StronglyTyped]
    public readonly partial record struct StronglyTypedIntWithEmptyProperty(int Value)
    {
        public static StronglyTypedIntWithEmptyProperty Empty => new(int.MaxValue);
