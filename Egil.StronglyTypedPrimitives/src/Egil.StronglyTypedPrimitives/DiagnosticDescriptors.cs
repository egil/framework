...
internal static class DiagnosticDescriptors
{
    ...
    /// <summary>
    /// The shared converter lives in the net10.0+ assets of the Abstractions assembly only, so a
    ...
    /// </summary>
    public static readonly DiagnosticDescriptor JsonSupportRequiresNet10 = new(
        id: "STP004",
        title: "System.Text.Json support for strongly typed primitives requires net10.0 or later",
        messageFormat: "No JsonConverter attribute is generated for '{0}' because Egil.StronglyTypedPrimitives.StronglyTypedJsonConverter<,> is not available to this compilation. System.Text.Json support for strongly typed primitives requires targeting net10.0 or later; on earlier targets declare a JsonConverter attribute on the partial declaration of '{0}' yourself.",
        category: Category,
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true,
        description: "The shared StronglyTypedJsonConverter ships only in the net10.0 and later assets of the package, so compilations that use the netstandard2.0 asset get no generated JSON support.");
