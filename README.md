...
- **[Orleans Messaging](https://github.com/egil/framework/tree/main/Egil.Orleans.Messaging):** Composable messaging infrastructure for Microsoft Orleans grains, including atomic state writes, durable outboxes, receiver-side deduplication, and stream subscription management.
...
- **[System.Text.Json Migration](https://github.com/egil/framework/tree/main/Egil.SystemTextJson.Migration):** A migration-focused extension for System.Text.Json that supports explicit migrator registration, optional scoped assembly discovery, and source-generated `JsonSerializerContext` support (trimmed/NativeAOT publishing is not supported yet).
